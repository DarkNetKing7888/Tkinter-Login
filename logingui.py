...
def login():
	...
	if c.fetchall():
		showinfo(title = "Login successful", message = "Username y contraseña correctos")
	else:
		showerror(title = "incorrect username or password", message = "Usuario o contraseña incorrecta")
